  ...
  return (
    <div className="mx-4 my-2 flex space-x-4">
      <div className="min-w-0 flex-1">
        ...
        <div className="flex items-center rounded-md px-2 ring-2 ring-gray-300 focus-within:ring-2 focus-within:ring-[#1d4ed8]">
          <div id="mainIcons">
          ...
          <textarea
            autoFocus={true}
            className="block w-full resize-none border-0 bg-transparent py-2 text-gray-900 placeholder:text-gray-400 focus:ring-0 dark:text-white sm:text-sm sm:leading-6"
            id="message"
            name="message"
          ...
          <Button
            ...
            icon={
              <PaperAirplaneIcon
                aria-hidden="true"
                className="h-5 w-5 flex-shrink-0 text-[#1d4ed8]"
              />
            }
            onClick={() => {
              onSend(message);
