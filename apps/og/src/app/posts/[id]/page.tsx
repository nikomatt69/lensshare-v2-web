...
import { LimitType, PublicationDocument, PublicationsDocument } from '@lensshare/lens';
...
export async function generateMetadata({ params }: Props): Promise<Metadata> {
  ...
  return {
    alternates: { canonical: `https://lenshareapp.xyz/posts/${targetPublication.id}` },
